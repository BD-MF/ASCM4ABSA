...
class ASCDataLoader:
    ...
    def collate_fn(batch):
        ...
        batch_max_seq_len = max([t['text_len'] for t in batch])
        for instance in batch:
            for k in instance:
                if k == 'dependency_tree' or k == 'dependency_graph':
                    new_batch[k].append(np.pad(instance[k],((0,batch_max_seq_len-instance['text_len']),(0,batch_max_seq_len-instance['text_len'])), 'constant'))
                else:
